...
enum ShaderDataFlag {
	...
	// TODO: we don't use vert motion so reusing it, but need to figure out better way to
	// add shadow catcher related data flags. Right now we have One Too Many.
	...
	SD_OBJECT_USE_SELF_SHADOWS  = (1 << 31),  /* object casts shadows on itself */
